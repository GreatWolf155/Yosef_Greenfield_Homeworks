...
while True:
    ...
    if user_answer_is_correct(question_index, user_choice):
        ...
        # takes out the question and any answers before our answer
        str_parts = questions[question_index].split(f"({answers[question_index]}) ")
        # removes the answers after our answer and prints the string remaining (the correct answer)
        print(f"The correct answer was: {str_parts[1].split(" (")[0]}")
